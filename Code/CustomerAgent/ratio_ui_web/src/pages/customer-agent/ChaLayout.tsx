...
const NAV: readonly NavItem[] = [
  ...
  { to: 'investigation-flow',    icon: 'fa-project-diagram', label: 'Neural Canvas v1', badge: 'v3' },
  { to: 'investigation-flow-v2', icon: 'fa-diagram-project', label: 'Neural Canvas v2', badge: 'v4' },
  { to: 'investigation-flow/detail', icon: 'fa-network-wired', label: 'Neural Canvas v3', badge: 'v5' },
  { to: 'investigation-flow-v4', icon: 'fa-circle-nodes',   label: 'Neural Canvas v4', badge: 'v6' },
